...
## Read consensus tree
tree <- read.tree("Data/consensus_tree_2021_current.nex")
...
############################################################################################################################
## Tip images will not be supplied with online code as permission was granted from Birds of the World - Cornell University
############################################################################################################################

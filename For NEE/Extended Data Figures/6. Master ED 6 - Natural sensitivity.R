...
post.samples_m1 <- readRDS("NEE main files/Second review/Data/results_data/Natural/full_medium_model_full_posterior_samples_natural.rds")
...
post.samples_h1 <- readRDS("NEE main files/Second review/Data/results_data/Natural/full_high_model_full_posterior_samples_natural.rds")
...
png("Figures/Publication/Extended Data/ED X - main_model_natural_100.png", width = 1572, height = 1675)
...
tiff("Figures/Publication/Extended Data/ED X - main_model_natural_tif.tif", width = 1572, height = 1675)

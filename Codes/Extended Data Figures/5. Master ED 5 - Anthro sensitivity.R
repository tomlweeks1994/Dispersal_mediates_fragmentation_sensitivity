...
post.samples_m1 <- readRDS("Output/full_medium_model_full_posterior_samples_anthro.rds")
...
post.samples_h1 <- readRDS("Output/full_high_model_full_posterior_samples_anthro.rds")
...
## Save plots
jpeg("Figures/Extended data figure 5.jpeg", width = 1572, height = 1675)

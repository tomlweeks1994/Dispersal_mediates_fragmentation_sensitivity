...
post.samples_m1 <- readRDS("Output/full_medium_model_full_posterior_samples.rds")
...
post.samples_h1 <- readRDS("Output/full_high_model_full_posterior_samples.rds")
...
png("Figures/Figure_4.png", width = 1572, height = 1675)
...
tiff("Figures/Figure_4.tif", width = 1572, height = 1675)

...
high_large_change <- readRDS("Output/full_high_model_full_posterior_samples_largest_change.rds")
...
high_small_change <- readRDS("Output/full_high_model_full_posterior_samples_smallest_change.rds")
...
### pull posterior samples ###
medium_large_change <- readRDS("Output/full_medium_model_full_posterior_samples_largest_change.rds")
...
## pull posteriors
medium_small_change <- readRDS("Output/full_medium_model_full_posterior_samples_smallest_change.rds")
...
png("Figures/Figure S2 interim tree cover change.png",
